...
from guardfs.common.config import (
    MEDIUM_WRITE_DELAY_MID,
    MEDIUM_WRITE_DELAY_HIGH,
    MEDIUM_WRITE_THRESHOLD_MID,
    MEDIUM_WRITE_THRESHOLD_HIGH,
    MEDIUM_SIZE_LIMIT,
)
...
async def handle_write_medium(
    ...
    if file_size < MEDIUM_SIZE_LIMIT:
    ...
    if count > MEDIUM_WRITE_THRESHOLD_HIGH:
        await trio.sleep(MEDIUM_WRITE_DELAY_HIGH)
    elif count > MEDIUM_WRITE_THRESHOLD_MID:
        await trio.sleep(MEDIUM_WRITE_DELAY_MID)
