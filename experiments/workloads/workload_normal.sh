...
# 사용법:
#   ./normal_workload.sh [대상_마운트_경로] [반복횟수]
#
# 예시:
#   ./normal_workload.sh ~/pure_fuse_lab/mount 100

TARGET_DIR="${1:-$HOME/pure_fuse_lab/mount}"
COUNT="${2:-100}"
...
LOG_DIR="$HOME/pure_fuse_lab/logs"
...
# Pure FUSE가 COMPLETE 상태를 읽도록 마지막 이벤트 발생
stat "$TARGET_DIR" > /dev/null

echo
echo "[DONE] 정상행위 워크로드 완료"
echo "필수 예상 연산:"
